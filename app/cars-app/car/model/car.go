...
type Car struct {
	...
	CarImages   []cim.CarImage `json:"car_images" gorm:"foreignKey:CarID;constraint:OnUpdate:CASCADE,OnDelete:CASCADE;"`
	...
	Features    []*f.Feature   `json:"features" gorm:"many2many:car_features;constraint:OnUpdate:CASCADE,OnDelete:CASCADE;"`
